...
{
    [super prepareLayout];
    CGFloat ItemW =self.collectionView.frame.size.width *0.5;
    CGFloat ItemH =self.collectionView.frame.size.height*0.5;
    ...
    self.minimumLineSpacing = ItemW* 0.7;
...
static CGFloat const HMActiveDistance = 180;
/** 缩放因素: 值越大, item就会越大 */
